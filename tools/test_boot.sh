...
check_string "Phase 4: System servers"  "[INIT] Phase 4: All servers spawned!"
check_string "Phase 5: POSIX hello"     "[INIT] Phase 5 PASSED"
check_regex  "POSIX hello output"       "\\[HELLO\\] Hello from POSIX! pid=[0-9]+"
check_string "FSTEST passed"            "[FSTEST] All filesystem tests PASSED"
check_string "MMAP_TEST passed"         "[MMAP_TEST] All memory management tests PASSED"
check_string "TEST_FORK passed"         "[TEST_FORK] All tests passed!"
