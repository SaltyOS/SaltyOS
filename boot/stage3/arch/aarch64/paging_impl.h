...
#define MAIR_IDX_DEVICE_nGnRnE                                                 \
  0 /* Device non-Gathering, non-Reordering, non-Early */
...
#define MAIR_NORMAL_WB                                                         \
  0xFFULL /* Inner/Outer Write-Back, Read-Allocate, Write-Allocate */
...
#define PTE_KERNEL_CODE                                                        \
  (PTE_VALID | PTE_AF | PTE_SH_IS | PTE_ATTR_IDX(MAIR_IDX_NORMAL_WB) |         \
   PTE_AP_RO_EL1 | PTE_UXN)
#define PTE_KERNEL_DATA                                                        \
  (PTE_VALID | PTE_AF | PTE_SH_IS | PTE_ATTR_IDX(MAIR_IDX_NORMAL_WB) |         \
   PTE_AP_RW_EL1 | PTE_PXN | PTE_UXN)
#define PTE_KERNEL_RWX                                                         \
  (PTE_VALID | PTE_AF | PTE_SH_IS | PTE_ATTR_IDX(MAIR_IDX_NORMAL_WB) |         \
   PTE_AP_RW_EL1)
#define PTE_DEVICE                                                             \
  (PTE_VALID | PTE_AF | PTE_SH_NS | PTE_ATTR_IDX(MAIR_IDX_DEVICE_nGnRnE) |     \
   PTE_AP_RW_EL1 | PTE_PXN | PTE_UXN)
...
#define TCR_EL1_VALUE                                                          \
  (TCR_T0SZ(16) | TCR_T1SZ(16) | TCR_TG0_4K | TCR_TG1_4K | TCR_SH0_IS |        \
   TCR_SH1_IS | TCR_ORGN0_WB_WA | TCR_IRGN0_WB_WA | TCR_ORGN1_WB_WA |          \
   TCR_IRGN1_WB_WA | TCR_IPS_48BIT)

/* TCR_EL2 configuration for 48-bit VA, 4KB granule */
#define TCR_EL2_PS_48BIT (5ULL << 16)

#define TCR_EL2_VALUE                                                          \
  (TCR_T0SZ(16) | TCR_TG0_4K | TCR_SH0_IS | TCR_ORGN0_WB_WA |                  \
   TCR_IRGN0_WB_WA | TCR_EL2_PS_48BIT)
