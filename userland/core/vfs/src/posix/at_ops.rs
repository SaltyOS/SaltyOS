...
use crate::client::{
    extract_dual_paths, extract_path, flags_allow_write, get_client, get_client_noalloc,
    object_open_flags,
};
use crate::consts::*;
...
use super::procfs::{handle_proc_open, handle_proc_readlink, handle_proc_stat};
use crate::ramfs::{
...
pub(crate) unsafe fn do_open(
    ...
    unsafe {
        ...
        // Mount point: open as OBJ_TYPE_MOUNT backed by the mounted FS
                ...
                if m.active != 0 && m.mount_ino == (*inode).ino {
                    ...
                    for fd in 0..(*cli).objects_cap as usize {
                        if (*(*cli).objects.add(fd)).active == 0 {
                            ...
                            (*(*cli).objects.add(fd)).dev_type = i as u8;
