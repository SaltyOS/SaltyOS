...
pub(crate) unsafe fn handle_isatty(msg: *const SaltyMsg, reply: *mut SaltyMsg, badge: u64) {
    unsafe {
...
pub(crate) unsafe fn handle_tcgetattr(msg: *const SaltyMsg, reply: *mut SaltyMsg, badge: u64) {
    unsafe {
        let fd = (*msg).regs[0] as i32;
        let cli = get_client(badge);
        if cli.is_null()
...
pub(crate) unsafe fn handle_tcsetattr(msg: *const SaltyMsg, reply: *mut SaltyMsg, badge: u64) {
    unsafe {
        let fd = (*msg).regs[0] as i32;
        let cli = get_client(badge);
        if cli.is_null()
...
pub(crate) unsafe fn handle_ioctl(msg: *const SaltyMsg, reply: *mut SaltyMsg, badge: u64) {
    unsafe {
        let fd = (*msg).regs[0] as i32;
...
pub(crate) unsafe fn handle_ioctl_fb0(request: u64, reply: *mut SaltyMsg) {
    unsafe {
        match request {
            // FBIOGET_VSCREENINFO
            0x4600 => {
...
pub(crate) unsafe fn handle_munmap(_msg: *const SaltyMsg, reply: *mut SaltyMsg, _badge: u64) {
    unsafe {
...
pub(crate) unsafe fn handle_mmap(msg: *const SaltyMsg, reply: *mut SaltyMsg, badge: u64) {
    unsafe {
        let fd = (*msg).regs[0] as i32;
...
pub(crate) unsafe fn handle_fcntl(msg: *const SaltyMsg, reply: *mut SaltyMsg, badge: u64) {
    unsafe {
        let fd = (*msg).regs[0] as i32;
...
pub(crate) unsafe fn handle_chdir(msg: *const SaltyMsg, reply: *mut SaltyMsg, badge: u64) {
    unsafe {
...
pub(crate) unsafe fn handle_getcwd(msg: *const SaltyMsg, reply: *mut SaltyMsg, badge: u64) {
    unsafe {
...
pub(crate) unsafe fn handle_shm_unlink(msg: *const SaltyMsg, reply: *mut SaltyMsg) -> bool {
    unsafe {
        let mut path = [0u8; MAX_PATH_LEN];
